  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-white p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-5xl font-bold mb-2">Property Listings</h1>
        <p className="text-zinc-400 mb-10">Browse available properties</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {properties.length === 0 ? (
            ...
            properties.map((p) => (
              <a href={`/buyer/property/${p.id}`} key={p.id} className="bg-[#151515] border border-zinc-800 rounded-3xl overflow-hidden block hover:border-[#C8A76A] transition-colors">
                {p.thumbnail_url && (
